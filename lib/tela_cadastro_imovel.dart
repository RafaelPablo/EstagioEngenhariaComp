...
class CadastroObra extends StatefulWidget {
  static String tag = 'CadastroObra';
  _CadastroObraState createState() => _CadastroObraState();
}

//final obraReference = FirebaseDatabase.instance.reference().child('obra');

class _CadastroObraState extends State<CadastroObra> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title:
            new Text("Registrar obra", style: TextStyle(color: Colors.white)),
      ),
