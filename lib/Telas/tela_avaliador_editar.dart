...
class AvaliadorEditar extends StatefulWidget {
  static String tag = 'AvaliadorEditar';
  _AvaliadorEditarState createState() => _AvaliadorEditarState();
}

class _AvaliadorEditarState extends State<AvaliadorEditar> {
  ...
  Widget build(BuildContext context) {
    ...
    final descriptionLabel = FlatButton(
      child: Text('Editar avaliador', style: TextStyle(color: Colors.black54)),
      onPressed: () {},
    );
...
//            elevation: 5.0,
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title:
            new Text("Editar avaliador", style: TextStyle(color: Colors.white)),
      ),
